...
(
    ...
    constraint FK_Client_to_status foreign key (Status_id) references Social_Status (StatusID) on delete cascade
);
...
values ('Alex',
        ...
        (select StatusID from [bank-task].dbo.Social_Status where Status_name = 'Employed')),
       ('Anna',
        'Kirovca',
        '2001-07-31',
        '80255558877',
        ...
        (select StatusID from [bank-task].dbo.Social_Status where Status_name = 'Student')),
       ('Ivan',
        'Tkac',
        '1956-01-12',
        '80172223311',
        ...
        (select StatusID from [bank-task].dbo.Social_Status where Status_name = 'Retire')),
       ('Ivona',
        'Marek',
        '1997-12-10',
        '80339998877',
        ...
        (select StatusID from [bank-task].dbo.Social_Status where Status_name = 'Disabled')),
       ('Alecsandra',
        'Lina',
        '1966-03-26',
        '375296662211',
